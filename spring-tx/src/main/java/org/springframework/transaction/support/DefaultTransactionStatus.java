...
public class DefaultTransactionStatus extends AbstractTransactionStatus {
	 ...
	 * state for the internal transaction implementation <br>基础事务对象持有内部事务实现状态
	 * @param newTransaction if the transaction is new,
	 * else participating in an existing transaction <br>是否新事务，如果是表示创建新事务，否则则加入已有的事务
	 * @param newSynchronization if a new transaction synchronization
	 * has been opened for the given transaction <br>是否为给定的事务打开新的事务同步
	 * @param readOnly whether the transaction is read-only <br>这个事务是否只读
